...
class SplashScreen(Screen):
    ...
    def on_enter(self):
        # 5 SECONDS SPLASH
        Clock.schedule_once(self.go_to_menu, 5.0)
...
class MainMenuScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        main_box = BoxLayout(orientation='vertical', padding=20, spacing=15)
        ...
        # Buttons
        buttons_box = BoxLayout(orientation='vertical', spacing=15, size_hint=(1, 0.85))
